...
// Show up to 6 projects merged across all categories
const getFeaturedProjects = () => projects.slice(0, 3);
    ...
    <section id="portfolio" className="pb-24 pt-12 bg-brand-black/90">
      <div className="container mx-auto px-6">
        ...
        <div className="relative z-20 mb-20">
          <p className="text-center text-gray-300 my-8 font-secondary">
            Our expertise spans across a wide range of modern technologies.
          </p>
        ...
        <AnimatedText
          ...
          underlineDuration={2}
        /><br/>
        <h2 className="text-4xl  md:text-4xl text-center font-bold mb-6 font-primary">
              Real Goals. Real Businesses. Real Results.
            </h2>
        <p className="text-gray-200 text-center max-w-3xl mx-auto mt-8 mb-16 font-secondary">
         
         Every project we take on starts with one question — what is your 
          business goal? Here is what happened when we answered that question 
          for our clients.
        </p>

        {/* Merged project grid — no category sub-headings */}
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.technologies.slice(0, 4).map((tech, i) => (
                      <span key={i} className="bg-gray-800 text-xs text-gray-300 px-2 py-1 rounded-full font-tertiary">
                        {tech}
                      </span>
                    ))}
                  </div>
