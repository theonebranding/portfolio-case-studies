...
const ProjectPage = () => {
  ...
  useEffect(() => {
    const foundProject = projects.find(
      (p) => p.id.toString() === projectSlug || p.title.toLowerCase().replace(/\s+/g, "-") === projectSlug
    );
    ...
    <div className="min-h-screen bg-brand-black/95 min-w-full text-brand-white overflow-hidden">
      <div className="relative">
        <Button
          ...
          className="absolute top-8 left-8 z-20 h-14 w-14 rounded-full border-brand-yellow/80"
        >
          <ChevronLeft size={28} />
        </Button>
            ...
            titleComponent={
              <>
                <h1 className="text-4xl font-semibold text-white">
                  ...
                  <span className="text-4xl md:text-6xl font-bold mt-1 leading-none text-brand-yellow font-primary">{project.title}</span>
                </h1>
              </>
            }
          ...
          <div className="space-y-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2">
                <h3 className="text-3xl font-semibold mb-3 text-brand-yellow border-b border-brand-yellow/30 pb-2 font-primary">Project Description</h3>
                <p className="text-gray-300 leading-relaxed font-secondary">{project.description}</p>
              </div>

              <div className="lg:col-span-1">
                <h3 className="text-3xl font-semibold mb-3 text-brand-yellow border-b border-brand-yellow/30 pb-2 font-primary">Client Details</h3>
            ...
            <div>
              <h3 className="text-3xl font-primary font-semibold mb-3 text-brand-yellow border-b border-brand-yellow/30 pb-2">Problem Statement</h3>
            ...
            <div>
              <h3 className="text-3xl font-primary font-semibold mb-3 text-brand-yellow border-b border-brand-yellow/30 pb-2">Project Build</h3>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 font-tertiary">
                    {project.technologies?.map((tech, index) => (
                      <span key={index} className="bg-gray-800 text-gray-200 px-3 py-1 rounded-full text-sm">
                        {tech}
                      </span>
                    ))}
                  </div>
            ...
            <div>
              <h3 className="text-3xl font-primary font-semibold mb-3 text-brand-yellow border-b border-brand-yellow/30 pb-2">Project Results</h3>
              <p className="text-gray-300 leading-relaxed font-secondary">
                {project.results ||
                  project.journey ||
